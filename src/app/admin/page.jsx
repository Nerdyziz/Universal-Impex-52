...
export default function AdminPage() {
  ...
  if (!session) {
    return (
      <div className="min-h-screen bg-[#F1E6D2] flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 sm:p-12 max-w-md w-full text-center space-y-6">
      ...
      <div className="admin-header w-full bg-[#1a1a1a] px-6 sm:px-12 lg:px-24 py-8 sm:py-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => signOut()}
              className="flex items-center gap-2 bg-red-500/20 text-red-300 hover:bg-red-500/30 hover:text-white px-4 py-2.5 rounded-lg text-xs font-bold uppercase tracking-widest transition-all"
              title="Sign out"
            >
              <X className="w-4 h-4" />
              Sign Out
