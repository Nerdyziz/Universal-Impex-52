...
export const Card2 = forwardRef(({ customClass, ...rest }, ref) => (
...
const makeSlot = (i, distX, distY, total) => ({
  ...
  // Add Math.abs() to force the Z-axis backward
...
const CardSwap2 = ({
  ...
  const defaultContainerClass =
    "absolute bottom-0 left-0 translate-x-[5%] xl:scale-100 scale-[0.8] translate-y-[20%] origin-bottom-left perspective-[900px] overflow-visible";
